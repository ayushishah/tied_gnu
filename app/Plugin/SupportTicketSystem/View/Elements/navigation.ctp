        ...
        <div class="navbar-collapse collapse">
			...
			<li class="dropdown menu-large">
              ...
              <?php } ?>
                			...
                			<li><?php if(Auth::hasRoles(['stadmin','stcoordinator','superadmin'])) { echo $this->Html->link(__("Manage Tickets"),array('plugin'=>'support_ticket_system','controller' => 'tickets', 'action' => 'manage_tickets')); } ?></li>
                			<li><?php if(Auth::hasRoles(['stadmin','superadmin'])) { echo $this->Html->link(__("View all tickets"), array('plugin'=>'support_ticket_system','controller' => 'tickets', 'action' => 'adminindex')); }?></li>
