	...
	<tr>
		...
		<td class="actions">
			...
			if($admin['ManageRole']['recstatus'] == 1){
				echo $this->Form->postLink(__('', true), array('action' => 'deactivate_admin_superadmin', $admin['ManageRole']['id']),array('class' => 'glyphicon glyphicon-remove', 'escape' => false), null, __('Are you sure you want to Deactivate # %s?', $admin['ManageRole']['id'])); 
			}
		?>
